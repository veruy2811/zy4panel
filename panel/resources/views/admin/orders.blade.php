...
@section('content')
<h1 class="mb-5 text-3xl font-bold">Manage Orders</h1>
<div class="zy-card overflow-x-auto">
    <table class="zy-table">
        <thead><tr><th>ID</th><th>User</th><th>Product</th><th>Plan</th><th>Status</th><th>Total</th><th>Invoice</th></tr></thead>
